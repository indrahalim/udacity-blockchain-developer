...
contract StarNotary is ERC721Full {
    ...
    constructor() ERC721Full("Udacity Star Token", "UDCS") public {
    }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        if (msg.sender != address1 && msg.sender != address2) {
            revert("You cannot exchange star you don't own!");
        }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        address ownerAddress = ownerOf(_tokenId);
        require(msg.sender == ownerAddress, "You cannot transfer star you don't own!");
